...
namespace Altsis.Prism.Extensions.Regions
{
    ...
    public class CustomRegionNavigationService : IRegionNavigationService
    {
        ...
        /// <param name="navigationCallback">A callback to execute when the navigation request is completed.</param>
        /// <param name="navigationParameters">The navigation parameters specific to the navigation request.</param>
        public void RequestNavigate(Uri target, Action<NavigationResult> navigationCallback, NavigationParameters navigationParameters, IUnityContainer container)
        {
            if (navigationCallback == null) throw new ArgumentNullException("navigationCallback");

            try
            {
                this.DoNavigate(target, navigationCallback, navigationParameters, container);
            }
            catch (Exception e)
            {
                this.NotifyNavigationFailed(new NavigationContext(this, target), navigationCallback, e);
            ...
            IUnityContainer container)
        {
            ...
            {
                ExecuteNavigation(navigationContext, activeViews, navigationCallback, container);
            }
        }
